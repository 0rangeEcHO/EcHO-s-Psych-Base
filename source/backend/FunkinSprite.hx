...
class FunkinSprite extends FlxSprite
{
    ...
    public function new(x:Float = 0,y:Float = 0,?newGraphic:FlxGraphic) {
        ...
        //disabling this because most of mania is aliased.
    ...
    public function addAnimAndPlay(anim:String, fps:Int = 24, looping:Bool = true, forced:Bool = false, reversed:Bool = false, ?frame:Int) {
        this.animation.addByPrefix(anim, anim, fps, looping);
        this.animation.play(anim, forced, reversed, frame);
    }
}